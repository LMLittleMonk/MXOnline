# Generated by Django 2.2 on 2020-04-29 13:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('easy', '简单'), ('middle', '中等'), ('hard', '困难')], max_length=20, verbose_name='难度')),
                ('students', models.IntegerField(default=0, verbose_name='学习人数')),
                ('fav_nums', models.IntegerField(default=0, verbose_name='收藏人数')),
                ('click_nums', models.IntegerField(default=0, verbose_name='点击人数')),
                ('notice', models.CharField(default='', max_length=200, verbose_name='课程公告')),
